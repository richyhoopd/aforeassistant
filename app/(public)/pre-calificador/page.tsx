...
const promesas = [
  ...
  "El trámite ante tu AFORE es gratuito",
]
  ...
  return (
    <div className="bg-[linear-gradient(180deg,oklch(0.96_0.025_250),oklch(1_0_0)_320px)]">
      <div className="mx-auto w-full max-w-5xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <ul className="mx-auto mb-6 flex max-w-xl flex-wrap items-center justify-center gap-x-5 gap-y-1.5 text-[13px] font-medium text-ink/75">
          {promesas.map((p) => (
